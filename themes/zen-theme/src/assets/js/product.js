...
class Product extends BasePage {
    ...
    registerEvents() {
      ...
      salla.product.event.onPriceUpdated((res) => {
        ...
        app.productWeight.forEach((el) => {el.textContent = data.weight || ''});
        app.totalPrice.forEach((el) => {el.textContent = salla.money(data.price)});
        app.beforePrice.forEach((el) => {el.textContent = salla.money(data.regular_price)});
