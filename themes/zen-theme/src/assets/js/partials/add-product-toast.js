class AddToCartToast extends HTMLElement {
  ...
  updateDOM() {
    ...
    const productImage = this.escapeHTML(this.product.image || "");
    const productName = this.escapeHTML(this.product.name || "");
    const checkIconUrl = this.escapeHTML(this.checkIconUrl || "");
    const safeOptions = visibleOptions.map(opt => ({
      name: this.escapeHTML(opt.name || ""),
    ...
    this.innerHTML =  `
      ...
      <div class="s-add-product-toast__header">
        <div class="s-add-product-toast__header-content">
          <img src="${checkIconUrl}" alt="Success" width="16" height="16" class="s-add-product-toast__icon" />
      ...
      <div class="s-add-product-toast__body">
        <a href="${productUrl}" class="s-add-product-toast__image">
          <img src="${productImage}" alt="${productName}" loading="lazy" />
        </a>
        <div class="s-add-product-toast__details">
          <a href="${productUrl}" class="s-add-product-toast__name">${productName}</a>
