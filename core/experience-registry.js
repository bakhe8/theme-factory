...
const EXPERIENCES = {
  ...
  'scent-quiz': {
    id: 'scent-quiz',
    status: 'implemented',
    title: { ar: 'اختبار الرائحة المناسب', en: 'Scent Quiz' },
    defaultSlug: 'scent-quiz',
    defaultTitles: {
      ar: 'اختبر ذوقك العطري',
      en: 'Find Your Scent Match',
    },
    componentPreset: 'scent-quiz',
    componentPathPrefix: 'home',
    intent: 'اختبار تفاعلي محلي يساعد المتسوق على اختيار عطر مناسب عبر مطابقة اختياراته مع بيانات المنتجات العطرية دون أي طلبات شبكة أو توصية خارجية.',
    docsSources: [
      {
        title: 'Twilight.json',
        url: 'https://docs.salla.dev/421921m0',
    ...
    gate: {
      requiredFields: [
        { id: 'products', type: 'items', source: 'products' },
        { id: 'quiz_questions', type: 'collection' },
      ],
      twigMarkers: [
        'data-scent-quiz',
        'data-scent-quiz-option',
        'data-scent-quiz-result',
