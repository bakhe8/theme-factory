...
const IMAGE = {
  ...
  electronicsHero: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&q=80&w=1600',
  smartphone: 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&q=80&w=900',
  laptop: 'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?auto=format&fit=crop&q=80&w=900',
  headphones: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&q=80&w=900',
  gaming: 'https://images.unsplash.com/photo-1605901309584-818e25960a8f?auto=format&fit=crop&q=80&w=900',
  camera: 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?auto=format&fit=crop&q=80&w=900',
  smartHome: 'https://images.unsplash.com/photo-1558002038-1055907df827?auto=format&fit=crop&q=80&w=900',
  monitor: 'https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?auto=format&fit=crop&q=80&w=900',
  accessories: 'https://images.unsplash.com/photo-1583394838336-acd977736f90?auto=format&fit=crop&q=80&w=900',
...
const electronicsBrands = [
  { id: 61, key: 'orbit', name: 'Orbit Tech', url: 'brands/orbit-tech.html', logo: IMAGE.emptyPlaceholder },
  { id: 62, key: 'nova', name: 'Nova Devices', url: 'brands/nova-devices.html', logo: IMAGE.emptyPlaceholder },
  { id: 63, key: 'pulse', name: 'Pulse Audio', url: 'brands/pulse-audio.html', logo: IMAGE.emptyPlaceholder },
  { id: 64, key: 'pixel', name: 'Pixel Craft', url: 'brands/pixel-craft.html', logo: IMAGE.emptyPlaceholder },
];

const electronicsCategories = [
  { id: 61, key: 'smartphones', name: 'جوالات', url: 'categories/smartphones.html', icon: 'sicon-mobile', image: IMAGE.smartphone },
  { id: 62, key: 'laptops', name: 'لابتوبات', url: 'categories/laptops.html', icon: 'sicon-laptop', image: IMAGE.laptop },
  { id: 63, key: 'audio', name: 'سماعات وصوتيات', url: 'categories/audio.html', icon: 'sicon-volume-up', image: IMAGE.headphones },
  { id: 64, key: 'gaming', name: 'ألعاب وكونسول', url: 'categories/gaming.html', icon: 'sicon-game-controller', image: IMAGE.gaming },
  { id: 65, key: 'smart-home', name: 'منزل ذكي', url: 'categories/smart-home.html', icon: 'sicon-home', image: IMAGE.smartHome },
  { id: 66, key: 'cameras', name: 'كاميرات', url: 'categories/cameras.html', icon: 'sicon-camera', image: IMAGE.camera },
  { id: 67, key: 'monitors', name: 'شاشات', url: 'categories/monitors.html', icon: 'sicon-display', image: IMAGE.monitor },
  { id: 68, key: 'accessories', name: 'إكسسوارات', url: 'categories/accessories.html', icon: 'sicon-plug', image: IMAGE.accessories },
];

function electronicsProduct(overrides = {}) {
  const category = electronicsCategories.find((item) => item.key === overrides.family) || electronicsCategories[0];
  const brand = electronicsBrands.find((item) => item.key === overrides.brandKey) || electronicsBrands[0];
  return product({
    brand,
    category,
    categories: [category],
    family: category.key,
    warranty: overrides.warranty || 'ضمان سنتين',
    specs: overrides.specs || ['شحن سريع', 'دعم عربي', 'توافق مع تطبيق سلة'],
    connectivity: overrides.connectivity || ['Wi-Fi', 'Bluetooth'],
    delivery_note: overrides.delivery_note || 'توصيل سريع مع تغليف آمن للأجهزة',
    ...overrides,
  });
}
...
const electronicsProducts = [
  electronicsProduct({
    ...
    family: 'smartphones',
    brandKey: 'nova',
    name: 'جوال Nova X Pro 256GB 5G',
    subtitle: 'شاشة OLED، كاميرا 108MP، وشحن فائق السرعة',
    price: 2899,
    regular_price: 3299,
    sale_price: 2899,
    product_price: 3299,
    ...
    quantity: 24,
    sold_quantity: 118,
    specs: ['256GB', '12GB RAM', 'كاميرا 108MP', '5G'],
    connectivity: ['5G', 'Wi-Fi 6', 'Bluetooth 5.3', 'NFC'],
    image: { url: IMAGE.smartphone, alt: 'جوال Nova X Pro' },
    thumbnail: IMAGE.smartphone,
    rating: { stars: 5, count: 84 },
    promotion_title: 'عرض إطلاق',
    tags: ['5G', 'الأكثر مبيعاً'],
  }),
  electronicsProduct({
    id: 602,
    family: 'laptops',
    brandKey: 'orbit',
    name: 'لابتوب Orbit Creator 14',
    subtitle: 'أداء إنتاجي خفيف للمصممين وصناع المحتوى',
    price: 4599,
    regular_price: 4599,
    sale_price: 4599,
    product_price: 4599,
    quantity: 11,
    specs: ['Intel Core Ultra 7', '32GB RAM', '1TB SSD', 'شاشة 2.8K'],
    connectivity: ['Thunderbolt', 'Wi-Fi 6E', 'HDMI'],
    image: { url: IMAGE.laptop, alt: 'لابتوب Orbit Creator' },
    thumbnail: IMAGE.laptop,
    rating: { stars: 5, count: 36 },
  }),
  electronicsProduct({
    id: 603,
    family: 'audio',
    brandKey: 'pulse',
    name: 'سماعة Pulse ANC اللاسلكية',
    subtitle: 'عزل ضوضاء نشط وبطارية تدوم حتى 40 ساعة',
    price: 699,
    regular_price: 899,
    sale_price: 699,
    product_price: 899,
    is_on_sale: true,
    quantity: 38,
    specs: ['ANC', '40 ساعة', 'USB-C', 'مايكروفون مزدوج'],
    connectivity: ['Bluetooth 5.3', 'Multipoint'],
    image: { url: IMAGE.headphones, alt: 'سماعة Pulse ANC' },
    thumbnail: IMAGE.headphones,
  ...
  electronicsProduct({
    ...
    family: 'gaming',
    brandKey: 'orbit',
    name: 'باقة كونسول Orbit Play مع ذراعين',
    subtitle: 'Bundle ألعاب جاهز للهدية والاستخدام العائلي',
    price: 2199,
    regular_price: 2499,
    sale_price: 2199,
    product_price: 2499,
    ...
    type: 'bundle',
    quantity: 9,
    specs: ['1TB', '4K HDR', 'ذراعان', 'اشتراك 3 أشهر'],
    connectivity: ['Wi-Fi 6', 'HDMI 2.1', 'Bluetooth'],
    image: { url: IMAGE.gaming, alt: 'باقة كونسول Orbit Play' },
    thumbnail: IMAGE.gaming,
    rating: { stars: 5, count: 29 },
  }),
  electronicsProduct({
    id: 605,
    family: 'monitors',
    brandKey: 'pixel',
    name: 'شاشة PixelView 27 بوصة 4K',
    subtitle: 'ألوان دقيقة للعمل والألعاب',
    price: 1499,
    regular_price: 1499,
    sale_price: 1499,
    product_price: 1499,
    quantity: 0,
    status: 'out',
    specs: ['27 بوصة', '4K', '144Hz', 'USB-C Power Delivery'],
    connectivity: ['HDMI 2.1', 'DisplayPort', 'USB-C'],
    image: { url: IMAGE.monitor, alt: 'شاشة PixelView 4K' },
  ...
  electronicsProduct({
    ...
    family: 'cameras',
    brandKey: 'pixel',
    name: 'كاميرا Pixel Craft Mirrorless',
    subtitle: 'تصوير 4K وعدسة أساسية لصناعة المحتوى',
    price: 3799,
    regular_price: 3799,
    sale_price: 3799,
    product_price: 3799,
    quantity: 7,
    specs: ['24MP', '4K 60fps', 'عدسة 35mm', 'تثبيت بصري'],
    connectivity: ['Wi-Fi', 'USB-C', 'HDMI'],
    image: { url: IMAGE.camera, alt: 'كاميرا Pixel Craft' },
    thumbnail: IMAGE.camera,
  ...
  electronicsProduct({
    ...
    family: 'smart-home',
    brandKey: 'orbit',
    name: 'مركز تحكم المنزل الذكي Orbit Hub',
    subtitle: 'تحكم بالإضاءة والمكيفات والحساسات من مكان واحد',
    price: 499,
    regular_price: 499,
    sale_price: 499,
    product_price: 499,
    quantity: 26,
    specs: ['يدعم Matter', 'تحكم صوتي', 'جدولة ذكية'],
    connectivity: ['Wi-Fi', 'Zigbee', 'Bluetooth'],
    image: { url: IMAGE.smartHome, alt: 'Orbit Hub للمنزل الذكي' },
    thumbnail: IMAGE.smartHome,
    rating: { stars: 4, count: 17 },
  }),
  electronicsProduct({
    id: 608,
    family: 'accessories',
    brandKey: 'nova',
    name: 'شاحن USB-C سريع 100W مع كيبل',
    subtitle: 'شحن لابتوب وجوال وسماعة من منفذ واحد',
    price: 189,
    regular_price: 239,
    sale_price: 189,
    product_price: 239,
    is_on_sale: true,
    quantity: 73,
    specs: ['100W', 'GaN', 'كيبل 2 متر', 'حماية حرارة'],
    connectivity: ['USB-C PD', 'USB-A'],
    image: { url: IMAGE.accessories, alt: 'شاحن USB-C سريع' },
    thumbnail: IMAGE.accessories,
    rating: { stars: 5, count: 66 },
  }),
  electronicsProduct({
    id: 609,
    family: 'gaming',
    brandKey: 'pixel',
    name: 'كرت شاشة Pixel RTX 5070 OC',
    subtitle: 'طلب مسبق للدفعات المحدودة',
    price: 3299,
    regular_price: 3299,
    sale_price: 3299,
    product_price: 3299,
    quantity: 0,
    has_preorder_campaign: true,
    preorder: { label: 'احجز الدفعة القادمة' },
    specs: ['12GB GDDR7', 'Ray Tracing', 'تبريد ثلاثي', 'OC Edition'],
    connectivity: ['PCIe 5.0', 'HDMI 2.1', 'DisplayPort'],
    image: { url: IMAGE.gaming, alt: 'كرت شاشة Pixel RTX' },
    thumbnail: IMAGE.gaming,
    rating: { stars: 5, count: 14 },
  }),
  electronicsProduct({
    id: 610,
    family: 'accessories',
    brandKey: 'orbit',
    name: 'خدمة ضمان ممتد للأجهزة',
    subtitle: 'منتج رقمي يضاف لحماية الأجهزة بعد الشراء',
    price: 299,
    regular_price: 299,
    sale_price: 299,
    product_price: 299,
    type: 'digital',
    quantity: 999,
    warranty: 'ضمان ممتد سنة إضافية',
    specs: ['تفعيل رقمي', 'يشمل الأعطال الفنية', 'دعم داخل السعودية'],
    connectivity: ['يصل عبر البريد'],
    image: { url: IMAGE.squareBanner, alt: 'ضمان ممتد للأجهزة' },
    thumbnail: IMAGE.squareBanner,
    rating: { stars: 4, count: 23 },
  }),
  electronicsProduct({
    ...
    family: 'laptops',
    brandKey: 'nova',
    name: 'تابلت Nova Note 12 مع قلم',
    subtitle: 'للطلاب والاجتماعات والرسم السريع',
    price: 1799,
    regular_price: 1799,
    sale_price: 1799,
    product_price: 1799,
    quantity: 20,
    specs: ['12 بوصة', 'قلم ذكي', '128GB', 'بطارية يوم كامل'],
    connectivity: ['Wi-Fi 6', 'Bluetooth', 'USB-C'],
    image: { url: IMAGE.laptop, alt: 'تابلت Nova Note' },
    thumbnail: IMAGE.laptop,
    rating: { stars: 4, count: 33 },
  }),
  electronicsProduct({
    id: 612,
    family: 'smart-home',
    brandKey: 'pulse',
    name: 'نظام Mesh Wi-Fi 6 ثلاث قطع',
    subtitle: 'تغطية منزلية قوية للمتاجر والمنازل الكبيرة',
    price: 899,
    regular_price: 999,
    sale_price: 899,
    product_price: 999,
    is_on_sale: true,
    quantity: 15,
    specs: ['Wi-Fi 6', '3 قطع', 'تغطية 500 متر', 'تطبيق إدارة'],
    connectivity: ['Ethernet', 'Wi-Fi 6'],
    image: { url: IMAGE.smartHome, alt: 'نظام Mesh Wi-Fi' },
    thumbnail: IMAGE.smartHome,
    rating: { stars: 5, count: 27 },
  }),
];
...
const electronicsReviews = [
  {
    ...
    name: 'ماجد',
    user: 'ماجد',
    avatar: 'https://i.pravatar.cc/150?u=tech-majed',
    stars: 5,
    rating: 5,
    text: 'وصل الجوال بسرعة والتغليف ممتاز، صفحة المواصفات ساعدتني أقارن قبل الشراء.',
    content: 'وصل الجوال بسرعة والتغليف ممتاز، صفحة المواصفات ساعدتني أقارن قبل الشراء.',
  ...
  },
  {
    ...
    name: 'هند',
    user: 'هند',
    avatar: 'https://i.pravatar.cc/150?u=tech-hind',
    stars: 4,
    rating: 4,
    text: 'العزل ممتاز، وأتمنى ظهور مدة البطارية بوضوح أكثر في بطاقة المنتج.',
    content: 'العزل ممتاز، وأتمنى ظهور مدة البطارية بوضوح أكثر في بطاقة المنتج.',
  ...
  },
  {
    ...
    stars: 5,
    rating: 5,
    text: 'الباقة مناسبة كهدية، وجود الذراع الثاني داخل العرض كان واضحاً.',
    content: 'الباقة مناسبة كهدية، وجود الذراع الثاني داخل العرض كان واضحاً.',
    created_at: '2026-04-18',
  },
  {
    id: 64,
    ...
    name: 'سارة',
    user: 'سارة',
    avatar: 'https://i.pravatar.cc/150?u=tech-sara',
    stars: 4,
    rating: 4,
    text: 'الربط مع أجهزة المنزل الذكي كان سهلاً والوصف واضح.',
    content: 'الربط مع أجهزة المنزل الذكي كان سهلاً والوصف واضح.',
    created_at: '2026-04-12',
  },
];
...
const electronicsHome = {
  slides: [
    {
      image: IMAGE.electronicsHero,
      title: 'أجهزة مختارة بعروض تقنية',
      description: 'جوالات، لابتوبات، صوتيات، ألعاب ومنزل ذكي مع ضمان واضح.',
      without_overlay: false,
      url: 'categories/smartphones.html',
    },
    {
      image: IMAGE.gaming,
      title: 'ترقيات الألعاب والعمل',
      description: 'كونسول، شاشة، كرت شاشة وملحقات للترقية القادمة.',
      without_overlay: false,
  ...
  banners: [
    {
      image: IMAGE.laptop,
      url: 'categories/laptops.html',
      title: 'لابتوبات للعمل والدراسة',
      description: 'اختبر عرض المواصفات الثقيلة والأسعار المرتفعة.',
    },
    {
      image: IMAGE.headphones,
      url: 'categories/audio.html',
      title: 'صوتيات وسماعات',
      description: 'بطاريات وعزل وضمان داخل بطاقة المنتج.',
    },
    {
      image: IMAGE.smartHome,
      url: 'categories/smart-home.html',
      title: 'منزل ذكي',
      description: 'منتجات مرتبطة بالتوافق والاتصال والتجربة اليومية.',
    },
  ],
  links: electronicsCategories.map((category) => ({
    icon: category.icon,
    title: category.name,
    url: category.url,
  })),
  features: [
    { icon: 'sicon-shield-check', title: 'ضمان رسمي', text: 'ضمان واضح لكل جهاز وخدمة ما بعد البيع' },
    { icon: 'sicon-shipping-fast', title: 'توصيل آمن', text: 'تغليف مناسب للأجهزة عالية القيمة' },
    { icon: 'sicon-credit-card', title: 'دفع مرن', text: 'قسائم وعروض وتمويل حسب بيانات المتجر' },
  ],
  productSections: [
    { title: 'عروض الجوالات واللابتوبات', sub_title: 'أجهزة عالية القيمة لاختبار الأسعار والمواصفات', ids: [601, 602, 611, 608], limit: 4 },
    { title: 'الألعاب والترقية', sub_title: 'كونسول وبطاقات وشاشات للمتسوق التقني', ids: [604, 605, 609], limit: 4 },
    { title: 'صوتيات ومنزل ذكي', sub_title: 'منتجات تعتمد على الاتصال والتوافق', ids: [603, 607, 612], limit: 4 },
    { title: 'إكسسوارات وضمان', sub_title: 'منتجات مساعدة وبيع إضافي آمن', ids: [608, 610, 612], limit: 4 },
  ],
};
...
const fixtures = {
  ...
  'electronics-rich': {
    id: 'electronics-rich',
    title: 'Electronics Store Dataset',
    purpose: 'بيئة توليد واختبار لمتاجر الإلكترونيات: أجهزة عالية القيمة، مواصفات تقنية، ضمان، نفاد مخزون، طلب مسبق، باقات، وإكسسوارات بيع إضافي.',
    source_reference: {
      name: 'Synthetic electronics Salla store benchmark',
      url: 'docs/benchmarks/electronics.md',
      observed_patterns: [
        'تصنيفات تقنية واضحة حسب نوع الجهاز',
        'إظهار المواصفات والضمان والتوافق قبل قرار الشراء',
        'منتجات عالية القيمة تحتاج رسائل ثقة وشحن آمن',
        'حالات مخزون حقيقية: متاح، نافد، طلب مسبق',
        'باقات وإكسسوارات وخدمات رقمية كبيع إضافي',
      ],
    },
    store: {
      ...baseStore,
      ...
      description: 'متجر إلكترونيات تجريبي لاختبار ثيمات الأجهزة التقنية على منصة سلة.',
      slogan: 'تقنية واضحة قبل الشراء',
      logo: IMAGE.emptyPlaceholder,
      contacts: {
        mobile: '+966500006161',
        phone: '+966500006161',
        email: 'care@electronics-pro.example',
        whatsapp: '+966500006161',
      },
      social: {
        instagram: 'electronics_pro',
        twitter: 'electronics_pro',
        tiktok: 'electronics_pro',
        youtube: 'electronics_pro',
      },
      settings: {
        ...baseStore.settings,
        currencies_enabled: true,
    ...
    user: {
      ...users.registered,
      name: 'عميل مهتم بالتقنية',
      wishlist: [601, 602, 604, 609],
      wallet: { balance: 1250 },
    },
    users: Object.values(users),
    products: electronicsProducts,
    cart: cartFromProducts(electronicsProducts.slice(0, 3), {
      coupon: { code: 'TECH10', discount: 480 },
      total_discount: 480,
      sub_total: 8197,
      tax_amount: 1229.55,
      real_shipping_cost: 0,
    ...
    testimonials: electronicsReviews.map((review) => ({
      name: review.name,
      text: review.text,
      avatar: review.avatar || IMAGE.emptyPlaceholder,
      stars: review.stars,
    ...
    orders: [
      { id: 9601, status: 'delivered', total: 5198, items: electronicsProducts.slice(0, 2), url: 'customer/orders/9601.html' },
      { id: 9602, status: 'processing', total: 2199, items: [electronicsProducts[3]], url: 'customer/orders/9602.html' },
    ],
    blog: [
      { id: 61, title: 'كيف تقارن مواصفات الجوال قبل الشراء', url: 'blog/compare-smartphones.html', image: IMAGE.smartphone },
      { id: 62, title: 'دليل اختيار اللابتوب المناسب للدراسة والعمل', url: 'blog/laptop-buying-guide.html', image: IMAGE.laptop },
      { id: 63, title: 'ما الذي يعنيه ضمان الأجهزة في متجر سلة', url: 'blog/electronics-warranty.html', image: IMAGE.electronicsHero },
    ],
    home: electronicsHome,
    expectations: {
      minProducts: 12,
      minReviews: 4,
      minCategories: 8,
      requiredProductTypes: ['product', 'bundle', 'digital'],
      requiredProductFamilies: ['smartphones', 'laptops', 'audio', 'gaming', 'smart-home', 'cameras', 'monitors', 'accessories'],
      requiredElectronicsFields: ['warranty', 'specs', 'connectivity'],
      requiredHomeProductSections: ['عروض الجوالات واللابتوبات', 'الألعاب والترقية', 'صوتيات ومنزل ذكي', 'إكسسوارات وضمان'],
      requiresSaleProduct: true,
      requiresOutOfStockProduct: true,
      requiresPreorderProduct: true,
      requiresRegisteredUser: true,
...
function validateFixture(fixture) {
  ...
  products.forEach((item, index) => {
    ...
    for (const field of expectations.requiredElectronicsFields || []) {
      const value = item[field];
      const emptyObject = value && typeof value === 'object' && !Array.isArray(value) && Object.keys(value).length === 0;
      if (!value || (Array.isArray(value) && !value.length) || emptyObject) {
        issues.push(`${label}: حقل الإلكترونيات ${field} مفقود`);
      }
    }
  });
