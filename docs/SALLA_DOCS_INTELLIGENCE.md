...
- `node factory.js create <theme>` يفحص صلاحية ذاكرة الوثائق بعد إنشاء الثيم من القالب.
...
- `node factory.js certify <theme> --strict-docs` يجعل أي مكون غير مثبت في الوثائق سبباً للفشل.
